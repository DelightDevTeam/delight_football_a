                ...
                <table class="table table-flush" id="users-search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $user->phone }}</td>
                            <td>
                                <small class="badge badge-{{ $user->status == UserStatus::Active ? 'success' : 'danger' }}">{{ $user->status == UserStatus::Active ? 'active' : 'ban' }}</small>
                            </td>
                            ...
                            <td>
                                <a href="{{ route('admin.agent-transfer', $user->id) }}" data-bs-toggle="tooltip" data-bs-original-title="Transfer To Agent" class="btn btn-info btn-sm"><i class="fas fa-right-left text-white me-1"></i>ငွေလွဲမည်</a>
                                <a href="{{ route('admin.agent-cash-out', $user->id) }}" data-bs-toggle="tooltip" data-bs-original-title="Cash Out From Agent" class="btn btn-warning btn-sm">
