                        ...
                        <form action="{{ route('admin.users.update', ["user" => $user->id]) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <x-user_commission_selectbox label="Single Commission" name="single_commission"
                                    :message="$message" :max="$max_commissions['single_commission']" :value="$single_commission"/>
                            </div>
                            ...
                            @for ($i = 3; $i < 12; $i += 2)
                                <div class="row">
                                    ...
                                    <x-user_commission_selectbox :label="$label_1" :name="$name_1" :message="$message_1"
                                        :max="$max_commissions[$name_1]" value="{{old($name_1, $user->{$name_1})}}"/>
                                    <x-user_commission_selectbox :label="$label_2" :name="$name_2" :message="$message_2"
                                        :max="$max_commissions[$name_2]" value="{{old($name_2, $user->{$name_2})}}"/>
                                </div>
                            @endfor
                            {{-- submit button --}}
                            <div class="row">
