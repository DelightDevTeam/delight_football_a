                    ...
                    <div class="card-body col-md-12 mx-auto">
                        <form action="{{ route('admin.users.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-outline my-3">
                                        ...
                                        <input type="text" class="form-control" name="max_for_single_bet">
                            ...
                            <div class="row">
                                ...
                                @endphp
                                <x-user_commission_selectbox label="Single Commission" name="single_commission"
                                    :message="$message" :max="$max_commissions['single_commission']" />
                            </div>
                            ...
                            @for ($i = 3; $i < 12; $i += 2)
                                <div class="row">
                                    ...
                                    @endphp
                                    <x-user_commission_selectbox :label="$label_1" :name="$name_1" :message="$message_1"
                                        :max="$max_commissions[$name_1]" />
                                    <x-user_commission_selectbox :label="$label_2" :name="$name_2" :message="$message_2"
                                        :max="$max_commissions[$name_2]" />
                                </div>
                            @endfor
                            {{-- submit button --}}
                            <div class="row">
