  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="input-group input-group-outline is-valid my-3">
        ...
        <input type="text" class="form-control" name="m_c_two_commission">
      </div>
    ...
    <div class="col-md-6">
      ...
      <div class="input-group input-group-outline is-valid my-3">
        ...
        <input type="text" class="form-control" name="m_c_three_commission">
      </div>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="input-group input-group-outline is-valid my-3">
        ...
        <input type="text" class="form-control" name="m_c_four_commission">
      </div>
    ...
    <div class="col-md-6">
      ...
      <div class="input-group input-group-outline is-valid my-3">
        ...
        <input type="text" class="form-control" name="m_c_five_commission">
      </div>
 ...
 <div class="row">
    <div class="col-md-6">
      ...
      <div class="input-group input-group-outline is-valid my-3">
        ...
        <input type="text" class="form-control" name="m_c_six_commission">
      </div>
    ...
    <div class="col-md-6">
      ...
      <div class="input-group input-group-outline is-valid my-3">
        <input type="text" class="form-control" name="m_c_seven_commission">
      </div>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="input-group input-group-outline is-valid my-3">
        ...
        <input type="text" class="form-control" name="m_c_eight_commission">
      </div>
     ...
     <div class="col-md-6">
      ...
      <div class="input-group input-group-outline is-valid my-3">
        ...
        <input type="text" class="form-control" name="m_c_nine_commission">
      </div>
  ...
  {{-- 10 11 --}}
    ...
    <div class="col-md-6">
      ...
      <div class="input-group input-group-outline is-valid my-3">
        ...
        <input type="text" class="form-control" name="m_c_ten_commission">
      </div>
    ...
    <div class="col-md-6">
      ...
      <div class="input-group input-group-outline is-valid my-3">
        ...
        <input type="text" class="form-control" name="m_c_eleven_commission">
      </div>
