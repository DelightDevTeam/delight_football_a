            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="input-group input-group-outline is-valid my-3">
                  ...
                  <input type="text" class="form-control" name="parlay_2_commission" value="{{ $user->parlay_2_commission }}">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group input-group-outline is-valid my-3">
                  ...
                  <input type="text" class="form-control" name="parlay_3_commission" value="{{ $user->parlay_3_commission }}">
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="input-group input-group-outline is-valid my-3">
                  ...
                  <input type="text" class="form-control" name="parlay_4_commission" value="{{ $user->parlay_4_commission }}">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group input-group-outline is-valid my-3">
                  ...
                  <input type="text" class="form-control" name="parlay_5_commission" value="{{ $user->parlay_5_commission }}">
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="input-group input-group-outline is-valid my-3">
                  ...
                  <input type="text" class="form-control" name="parlay_6_commission" value="{{ $user->parlay_6_commission }}">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group input-group-outline is-valid my-3">
                  <input type="text" class="form-control" name="parlay_7_commission" value="{{ $user->parlay_7_commission }}">
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="input-group input-group-outline is-valid my-3">
                  ...
                  <input type="text" class="form-control" name="parlay_8_commission" value="{{ $user->parlay_8_commission }}">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group input-group-outline is-valid my-3">
                  ...
                  <input type="text" class="form-control" name="parlay_9_commission" value="{{ $user->parlay_9_commission }}">
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="input-group input-group-outline is-valid my-3">
                  ...
                  <input type="text" class="form-control" name="parlay_10_commission" value="{{ $user->parlay_10_commission }}">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group input-group-outline is-valid my-3">
                  ...
                  <input type="text" class="form-control" name="parlay_11_commission" value="{{ $user->parlay_11_commission }}">
                </div>
